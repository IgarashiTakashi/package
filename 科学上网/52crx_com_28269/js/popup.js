...
exports.default = {
	...
	IMAGES: {
		...
		PERMFIXGIF: "img/permission-fix.gif",
...
(0, _jquery2.default)(document).ready(function () {
  ...
  /*
      if (ClientMeta.PLATFORM.toLowerCase() == "firefox"){
        if (screenResolutionFactor != 100 && true) {
          const factor = screenResolutionFactor/100;
          const marginRight = -1 * (300 - Math.floor(300 * factor));
          $(htmlElement).css('transform', 'scale(0.75)');
          $(htmlElement).css('transform-origin', 'left top');
          //$(bodyElement).css('margin-right', -100);
        }
      }
  */
